...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="tangoesque"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="tango-esque"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset foreground-color "'#babdb6'"
        dset bold-color "'#babdb6'"
...
gset string foreground_color "#babdb6"
gset string bold_color "#babdb6"
